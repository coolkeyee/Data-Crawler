...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(1,2):
            URL = 'https://www.cmnh.org.cn/list/?22_1.html'
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            ...
            for line in response.xpath('/html/body/div[2]/div[3]/div[1]/ul/li'):  # 教育信息爬取
                print(1)
                # print(1)
                item = eduItem()
                item['mid'] = index
                ...
                item['name'] = line.xpath('./p/a/@title').extract()[0].strip()
                ...
                item['url'] = "https://www.cmnh.org.cn"+line.xpath('./p/a/@href').extract()[0]
                print(item['url'])

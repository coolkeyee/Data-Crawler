...
class EduSpider(SeleniumSpider):
    ...
    def start_requests(self):
        for page in range(1,2):
            URL = 'http://www.3gmuseum.cn/web/activity/educationReview.do?itemno=26&itemsonno=40288a28642b691a01642b6f7f430014'
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            ...
            for line in response.xpath('/html/body/div[2]/div/div[2]/ul/li'):  # 教育信息爬取
                print(1)
                # print(1)
                item = eduItem()
                item['mid'] = index
                ...
                item['name'] = line.xpath('./a/div/div[@class="review_detail floatLeft"]/p[@class="biaoti"]/text()').extract()[0].strip()
                ...
                item['url'] = "http://www.3gmuseum.cn/"+line.xpath('./a/@href').extract()[0]
                print(item['url'])

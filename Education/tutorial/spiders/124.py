...
class EduSpider(SeleniumSpider):
    ...
    def start_requests(self):
        for page in range(1,3):
            URL = 'http://www.nxgybwg.com/e/action/ListInfo/index.php?page={}&classid=45'.format(page)
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            ...
            for line in response.xpath('/html/body/div[2]/div/div[2]/div[2]/div[2]/dl'):  # 教育信息爬取
                print(1)
                # print(1)
                item = eduItem()
                item['mid'] = index
                ...
                item['name'] = line.xpath('./dt[1]/a/text()').extract()[0].strip()
                ...
                item['url'] = "http://www.nxgybwg.com"+line.xpath('./dt[1]/a/@href').extract()[0]
                print(item['url'])

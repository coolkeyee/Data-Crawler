...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(1,11):
            URL = 'http://www.jxmuseum.cn/News/List/shjy?page={}'.format(page)
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        for line in response.xpath('/html/body/div[3]/div/div/div[2]/div[1]/ul/li'):  # 教育信息爬取
            # print(1)
            item = eduItem()
            item['mid'] = index
            # print(item['mid'])
            ...
            item['name'] = line.xpath('./div/div[2]/a/h3/text()').extract()[0].strip()
            print(item['name'])
            # print(line.xpath('./h2/a/@href').extract())
            item['url'] = "http://www.jxmuseum.cn"+line.xpath('./div/div[2]/a/@href').extract()[0]
            print(item['url'])

...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(1, 5):
            URL = 'http://www.hnmuseum.com/zh-hans/huodong_zhuanti?s=/zh-hans/huodong_zhuanti&page={}'.format(page)
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            ...
            for line in response.xpath('/html/body/div[4]/div[1]/div[2]/div[2]/div[2]/div/div/div/div[2]/div/ul/li'):  # 教育信息爬取
                print(1)
                # print(1)
                item = eduItem()
                item['mid'] = index
                ...
                item['name'] = line.xpath('./div[2]/span/a/text()').extract()[0].strip()
                # '/html/body/div[6]/div[4]/div[1]/div[9]/div/table/tbody/tr[1]/td/table[9]/tbody/tr[1]/td[2]/a/b'
                print(item['name'])
                # print(line.xpath('./h2/a/@href').extract())
                # '/html/body/div[2]/table/tbody/tr[4]/td/table/tbody/tr[1]/td[1]/a/span'
                item['url'] = "http://www.hnmuseum.com"+line.xpath('./div[2]/span/a/@href').extract()[0]
                print(item['url'])

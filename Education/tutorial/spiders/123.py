...
class EduSpider(SeleniumSpider):
    ...
    def start_requests(self):
        for page in range(1,11):
            URL = 'http://public.dha.ac.cn/list.aspx?ID=752571666216&Page={}'.format(page)
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            ...
            for line in response.xpath('/html/body/div[2]/div[2]/div/ul/table[2]/tbody/tr'):  # 教育信息爬取
                print(1)
                # print(1)
                item = eduItem()
                item['mid'] = index
                ...
                item['name'] = line.xpath('./td/li/a/text()').extract()[0].strip()
                ...
                item['url'] = line.xpath('./td/li/a/@href').extract()[0]
                print(item['url'])

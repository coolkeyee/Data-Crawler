...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
            URL = 'http://www.zhejiangmuseum.com/zjbwg/education.html'
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        for line in response.xpath('/html/body/div[3]/div[1]/div[2]/div[2]/ul/li'):  # 教育信息爬取
            # print(1)
            item = eduItem()
            item['mid'] = index
            # print(item['mid'])
            ...
            item['url'] = "http://www.zhejiangmuseum.com/"+line.xpath('./a/@href').extract()[0]
            print(item['url'])

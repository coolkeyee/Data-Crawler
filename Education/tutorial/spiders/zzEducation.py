...
class EduSpider(scrapy.Spider):
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            for line in response.xpath('/html/body/div[4]/div'):  # 教育信息爬取
                # print(1)
                item = eduItem()
                item['mid'] = index
                # print(item['mid'])
                ...
                item['name'] = line.xpath('./div[1]/a/p[1]/text()').extract()[0].strip()
                print(item['name'])
                # print(line.xpath('./h2/a/@href').extract())
                # '/html/body/div[2]/table/tbody/tr[4]/td/table/tbody/tr[1]/td[1]/a/span'
                item['url'] = "http://www.hnzzmuseum.com"+line.xpath('./div[1]/a/@href').extract()[0]
                print(item['url'])

...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(1, 5):
            URL = 'http://www.zdm.cn/scenery.html?page={}'.format(page)
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            ...
            for line in response.xpath('/html/body/section[2]/div/div[@class="row list"]'):  # 教育信息爬取
                print(1)
                # print(1)
                item = eduItem()
                item['mid'] = index
                ...
                item['name'] = line.xpath('./div[2]/a/p[1]/text()').extract()[0].strip()
                ...
                item['url'] = line.xpath('./div[2]/a/@href').extract()[0]
                print(item['url'])

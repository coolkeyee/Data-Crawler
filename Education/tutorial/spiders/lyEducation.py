...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(1, 2):
            URL = 'http://www.lymuseum.com/list.php?fid=70'
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,12):
            if i == 8 :continue
            for line in response.xpath('/html/body/div[6]/div[4]/div[1]/div[9]/div/table/tr[1]/td/table[{}]'.format(i)):  # 教育信息爬取
                # print(1)
                item = eduItem()
                item['mid'] = index
                # print(item['mid'])
                ...
                item['name'] = line.xpath('./tr[1]/td[2]/a/b/text()').extract()[0].strip()
                # '/html/body/div[6]/div[4]/div[1]/div[9]/div/table/tbody/tr[1]/td/table[9]/tbody/tr[1]/td[2]/a/b'
                print(item['name'])
                # print(line.xpath('./h2/a/@href').extract())
                # '/html/body/div[2]/table/tbody/tr[4]/td/table/tbody/tr[1]/td[1]/a/span'
                item['url'] = "http://www.lymuseum.com/"+line.xpath('./tr[1]/td[2]/a/@href').extract()[0]
                print(item['url'])

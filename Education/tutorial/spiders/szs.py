    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(2,7):
            ...
            for line in response.xpath('/html/body/div[4]/div[{}]'.format(i)):  # 教育信息爬取
                print(1)
                # print(1)
                item = eduItem()
                item['mid'] = index
                ...
                item['name'] = line.xpath('./div[2]/p[1]/a/text()').extract()[0].strip()
                ...
                item['url'] = line.xpath('./div[2]/p[1]/a/@href').extract()[0]
                print(item['url'])

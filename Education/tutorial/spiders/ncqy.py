...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(1,6):
            URL = 'http://www.81-china.com/service/66/{}.html'.format(page)
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        for line in response.xpath('/html/body/div/div[5]/div[3]/div[2]/ul/li'):  # 教育信息爬取
            # print(1)
            item = eduItem()
            item['mid'] = index
            # print(item['mid'])
            ...
            item['url'] = "http://www.81-china.com"+line.xpath('./div[1]/a/@href').extract()[0]
            print(item['url'])

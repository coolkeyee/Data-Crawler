...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(1, 2):
            URL = 'http://nyhhg.com/a/zx/jiaoyuhuodonggongshi/'
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            if i == 8 :continue
            for line in response.xpath('/html/body/div[4]/div[2]/div[2]/ul/li'):  # 教育信息爬取
                # print(1)
                item = eduItem()
                item['mid'] = index
                # print(item['mid'])

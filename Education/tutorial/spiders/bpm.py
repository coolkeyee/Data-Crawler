...
class EduSpider(SeleniumSpider):
    ...
    def start_requests(self):
        for page in range(1,2):
            URL = 'https://bpmuseum.com/index.php?m=content&c=index&a=lists&catid=7'
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            ...
            for line in response.xpath('/html/body/div[1]/div[5]/div/div/div[3]/div[1]/ul/li'):  # 教育信息爬取
                print(1)
                # print(1)
                item = eduItem()
                item['mid'] = index
                ...
                item['name'] = line.xpath('./div[1]/a/@title').extract()[0].strip()
                ...
                item['url'] = line.xpath('./div[1]/a/@href').extract()[0]
                print(item['url'])

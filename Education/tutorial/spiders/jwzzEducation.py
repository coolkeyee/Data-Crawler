...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(1,4):
            URL = 'http://www.jiawuzhanzheng.org/paper-cat/museum-works/page/{}'.format(page)
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        for line in response.xpath('/html/body/div[2]/div/div[2]/div[1]/div[1]/div[1]/div/div/ul/li'):  # 教育信息爬取
            # print(1)
            item = eduItem()
            item['mid'] = index
            # print(item['mid'])
            ...
            item['name'] = line.xpath('./a/@title').extract()[0].strip()
            print(item['name'])

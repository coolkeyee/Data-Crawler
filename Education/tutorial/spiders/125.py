...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(1,3):
            URL = 'https://www.nxbwg.com/c/xcjy.html?filter=&id=2&diyname=xcjy&page={}'.format(page)
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            ...
            # print(response.xpath('/html/body/div[2]/div/div[2]/div[2]/div[2]/dl'))
            for line in response.xpath('/html/body/div[1]/div[2]/div[2]/main/div/div/div/article'):  # 教育信息爬取
                print(1)
                # print(1)
                item = eduItem()
                item['mid'] = index
                ...
                item['name'] = line.xpath('./div[1]/h3/a/text()').extract()[0].strip()
                ...
                item['url'] = "https://www.nxbwg.com"+line.xpath('./div[1]/h3/a/@href').extract()[0]
                print(item['url'])

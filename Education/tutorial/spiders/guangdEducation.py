...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(1, 7):
            URL = 'http://www.gdmuseum.com/gdmuseum/_301014/_300878/d205f4c5-{}.html'.format(page)
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            ...
            for line in response.xpath('/html/body/div[7]/dl/dd/div/div[2]/div[1]/div'):  # 教育信息爬取
                print(1)
                # print(1)
                item = eduItem()
                item['mid'] = index

...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(1, 10):
            URL = 'http://www.zunyihy.cn/rraining_record/p/{}.html'.format(page)
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            ...
            for line in response.xpath('/html/body/div[4]/div[2]/div/div[2]/div[1]/div'):  # 教育信息爬取
                print(1)
                # print(1)
                item = eduItem()
                item['mid'] = index
                ...
                item['name'] = line.xpath('./a/div[2]/text()').extract()[0].strip()
                ...
                item['url'] = "http://www.zunyihy.cn/"+line.xpath('./a/@href').extract()[0]
                print(item['url'])

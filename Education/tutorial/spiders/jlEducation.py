...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(2, 11):
            URL = 'http://www.jlmuseum.org/activitys/{}.html'.format(page)
            # print(URL)
    ...
    def parse(self, response):
       ...
       # ' / html / body / div / div / div[2] / div[2] / ul[1] / li[2] / div / a / h3 / strong'
        for line in response.xpath('/html/body/div[2]/div[2]/div[3]/ul/li'):  # 教育信息爬取
            # print(1)
            item = eduItem()
            item['mid'] = index
            # print(item['mid'])
            ...
            item['url'] = "http://www.jlmuseum.org" + line.xpath('./a/@href').extract()[0]
            print(item['url'])

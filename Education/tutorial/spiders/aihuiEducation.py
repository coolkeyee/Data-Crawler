...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        URL = 'http://www.aihuihistorymuseum.org.cn/newlist.aspx?type=382'
        # print(URL)
    ...
    def parse(self, response):
       ...
       # ' / html / body / div / div / div[2] / div[2] / ul[1] / li[2] / div / a / h3 / strong'
        for line in response.xpath('/html/body/form/div[4]/div[1]/div/div[2]/div[2]/ul/li'):  # 教育信息爬取
            # print(1)
            item = eduItem()
            item['mid'] = index
            # print(item['mid'])
            ...
            item['url'] = "http://www.aihuihistorymuseum.org.cn/" + line.xpath('./a/@href').extract()[0]
            print(item['url'])

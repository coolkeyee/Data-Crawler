...
class EduSpider(SeleniumSpider):
    ...
    def start_requests(self):
        for page in range(1,2):
            URL = 'http://www.bmy.com.cn/html/public/jy/jyhd/541e8487f2b24936aab964fb551a38d7.html?mode=%E6%95%99%E8%82%B2%E6%B4%BB%E5%8A%A8&code=005004002'
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            ...
            for line in response.xpath('/html/body/div[2]/div[1]/div'):  # 教育信息爬取
                print(1)
                # print(1)
                item = eduItem()
                item['mid'] = index
                ...
                item['name'] = line.xpath('./a/p/span/text()').extract()[0].strip()

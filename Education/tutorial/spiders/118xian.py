...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(1,11):
            URL = 'http://www.xabwy.com/sitepage.aspx?id=217&page={}'.format(page)
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            ...
            for line in response.xpath('/html/body/div[1]/div[3]/div/div[1]/div/div/div[2]/div[2]/div[2]/div[2]/div[2]/ul/li'):  # 教育信息爬取
                print(1)
                # print(1)
                item = eduItem()
                item['mid'] = index

...
class EduSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for page in range(1, 2):
            URL = 'http://www.ytmuseum.com/zhishi/list.html'
        # print(URL)
    ...
    def parse(self, response):
       ...
       #  print(response.xpath('/html/body/form/div[3]/table/tr/td/table/tr[3]/td/table/tr[3]/td/table/tr/td[3]/div/span[2]/div/table[1]/tr[1]'))
        ...
        for i in range(1,2):
            for line in response.xpath('/html/body/div[2]/div[3]/div/div[1]/ul/li'):  # 教育信息爬取
                # print(1)
                item = eduItem()
                item['mid'] = index
                # print(item['mid'])
                ...
                # '/html/body/div[2]/table/tbody/tr[4]/td/table/tbody/tr[1]/td[1]/a/span'
                item['url'] = "http://www.ytmuseum.com"+line.xpath('./a/@href').extract()[0]
                print(item['url'])
